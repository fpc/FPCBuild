...
renametoshort:
	...
	-mv $(PKGPRE)$(PKGUNITSPRE)googpleapi$(ZIPSUFFIX).zip ugapi$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGPRE)$(PKGUNITSPRE)httpd2.4$(ZIPSUFFIX).zip uhd24$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGPRE)$(PKGUNITSPRE)librsvg$(ZIPSUFFIX).zip ulrsv$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGPRE)$(PKGUNITSPRE)libxml$(ZIPSUFFIX).zip ulxml$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGPRE)utils-pas2js$(ZIPSUFFIX).zip up2js$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGPRE)utils-tply$(ZIPSUFFIX).zip utply$(ZIPSUFFIXSHORT).zip
