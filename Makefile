...
fpcsrc/build-stamp.arm-android:
	$(MAKE) -C fpcsrc crossall OS_TARGET=android CPU_TARGET=arm CROSSBINDIR=$(ANDROID_ARM_BINUTILS) BINUTILSPREFIX=arm-linux-androideabi- CROSSOPT="$(CROSSOPT) -Fl$(NDK_LIB)/arch-arm/usr/lib"
build_android_aarch64: fpcsrc/build-stamp.aarch64-android
fpcsrc/build-stamp.aarch64-android:
	$(MAKE) -C fpcsrc crossall OS_TARGET=android CPU_TARGET=aarch64 CROSSBINDIR=$(ANDROID_AARCH64_BINUTILS) BINUTILSPREFIX=aarch64-linux-android- CROSSOPT="$(CROSSOPT) -Fl$(NDK_LIB)/arch-arm64/usr/lib"
build_android_i386: fpcsrc/build-stamp.i386-android
fpcsrc/build-stamp.i386-android:
	$(MAKE) -C fpcsrc crossall OS_TARGET=android CPU_TARGET=i386 CROSSBINDIR=$(ANDROID_X86_BINUTILS) BINUTILSPREFIX=i686-linux-android- CROSSOPT="$(CROSSOPT) -Fl$(NDK_LIB)/arch-x86/usr/lib"
build_android_x86_64: fpcsrc/build-stamp.x86_64-android
fpcsrc/build-stamp.x86_64-android:
	$(MAKE) -C fpcsrc crossall OS_TARGET=android CPU_TARGET=x86_64 CROSSBINDIR=$(ANDROID_X86_64_BINUTILS) BINUTILSPREFIX=x86_64-linux-android- CROSSOPT="$(CROSSOPT) -Fl$(NDK_LIB)/arch-x86_64/usr/lib64"
build_android_mipsel: fpcsrc/build-stamp.mipsel-android
fpcsrc/build-stamp.mipsel-android:
	$(MAKE) -C fpcsrc crossall OS_TARGET=android CPU_TARGET=mipsel CROSSBINDIR=$(ANDROID_MIPS_BINUTILS) BINUTILSPREFIX=mipsel-linux-android- CROSSOPT="$(CROSSOPT) -Fl$(NDK_LIB)/arch-mips/usr/lib"
...
innoandroidbuild:
	...
	$(MAKE) -C fpcsrc rtl_clean packages_clean OS_TARGET=android CPU_TARGET=arm
	$(MAKE) build_android_arm OS_TARGET=android CPU_TARGET=arm CROSSOPT="-Cparmv7a -Cfvfpv3_d16"
	$(MAKE) crossinstall INSTALL_PREFIX=$(INNODIR) OS_TARGET=android CPU_TARGET=arm
