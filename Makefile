...
fpcsrc_smart:
	$(MAKE) -C fpcsrc smart
fpcsrc_release:
	$(MAKE) -C fpcsrc release
fpcsrc_units:
	$(MAKE) -C fpcsrc units
fpcsrc_examples:
	$(MAKE) -C fpcsrc examples
fpcsrc_shared:
	$(MAKE) -C fpcsrc shared
fpcsrc_install:
	$(MAKE) -C fpcsrc install
fpcsrc_sourceinstall:
	$(MAKE) -C fpcsrc sourceinstall
fpcsrc_exampleinstall:
	$(MAKE) -C fpcsrc exampleinstall
fpcsrc_distinstall:
	$(MAKE) -C fpcsrc distinstall
fpcsrc_zipinstall:
	$(MAKE) -C fpcsrc zipinstall
fpcsrc_zipsourceinstall:
	$(MAKE) -C fpcsrc zipsourceinstall
fpcsrc_zipexampleinstall:
	$(MAKE) -C fpcsrc zipexampleinstall
fpcsrc_zipdistinstall:
	$(MAKE) -C fpcsrc zipdistinstall
fpcsrc_clean:
	$(MAKE) -C fpcsrc clean
fpcsrc_distclean:
	$(MAKE) -C fpcsrc distclean
fpcsrc_cleanall:
	$(MAKE) -C fpcsrc cleanall
fpcsrc_info:
	$(MAKE) -C fpcsrc info
fpcsrc_makefiles:
	$(MAKE) -C fpcsrc makefiles
fpcsrc:
	$(MAKE) -C fpcsrc all
.PHONY: fpcsrc_all fpcsrc_debug fpcsrc_smart fpcsrc_release fpcsrc_units fpcsrc_examples fpcsrc_shared fpcsrc_install fpcsrc_sourceinstall fpcsrc_exampleinstall fpcsrc_distinstall fpcsrc_zipinstall fpcsrc_zipsourceinstall fpcsrc_zipexampleinstall fpcsrc_zipdistinstall fpcsrc_clean fpcsrc_distclean fpcsrc_cleanall fpcsrc_info fpcsrc_makefiles fpcsrc
endif
ifdef TARGET_DIRS_FPCDOCS
fpcdocs_all:
	$(MAKE) -C fpcdocs all
fpcdocs_debug:
	$(MAKE) -C fpcdocs debug
fpcdocs_smart:
	$(MAKE) -C fpcdocs smart
fpcdocs_release:
	$(MAKE) -C fpcdocs release
fpcdocs_units:
	$(MAKE) -C fpcdocs units
fpcdocs_examples:
	$(MAKE) -C fpcdocs examples
fpcdocs_shared:
	$(MAKE) -C fpcdocs shared
fpcdocs_install:
	$(MAKE) -C fpcdocs install
fpcdocs_sourceinstall:
	$(MAKE) -C fpcdocs sourceinstall
fpcdocs_exampleinstall:
	$(MAKE) -C fpcdocs exampleinstall
fpcdocs_distinstall:
	$(MAKE) -C fpcdocs distinstall
fpcdocs_zipinstall:
	$(MAKE) -C fpcdocs zipinstall
fpcdocs_zipsourceinstall:
	$(MAKE) -C fpcdocs zipsourceinstall
fpcdocs_zipexampleinstall:
	$(MAKE) -C fpcdocs zipexampleinstall
fpcdocs_zipdistinstall:
	$(MAKE) -C fpcdocs zipdistinstall
fpcdocs_clean:
	$(MAKE) -C fpcdocs clean
fpcdocs_distclean:
	$(MAKE) -C fpcdocs distclean
fpcdocs_cleanall:
	$(MAKE) -C fpcdocs cleanall
fpcdocs_info:
	$(MAKE) -C fpcdocs info
fpcdocs_makefiles:
	$(MAKE) -C fpcdocs makefiles
fpcdocs:
	$(MAKE) -C fpcdocs all
.PHONY: fpcdocs_all fpcdocs_debug fpcdocs_smart fpcdocs_release fpcdocs_units fpcdocs_examples fpcdocs_shared fpcdocs_install fpcdocs_sourceinstall fpcdocs_exampleinstall fpcdocs_distinstall fpcdocs_zipinstall fpcdocs_zipsourceinstall fpcdocs_zipexampleinstall fpcdocs_zipdistinstall fpcdocs_clean fpcdocs_distclean fpcdocs_cleanall fpcdocs_info fpcdocs_makefiles fpcdocs
endif
...
fpcsrc/build-stamp.cross-msdos:
	$(MAKE) -C fpcsrc clean buildbase OS_TARGET=msdos CPU_TARGET=i8086 OPT="-CX -XXs" BINUTILSPREFIX= CROSSOPT="-Wm$(MEMORY_MODEL) -Cp$(SUBARCH)"
	$(ECHO) $(DATE) > fpcsrc/build-stamp.cross-msdos
...
renametoshort:
	...
	-$(MOVE) $(PKGPRE)utils-debugsrv$(ZIPSUFFIX).zip udbgs$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-dxegen$(ZIPSUFFIX).zip udxeg$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpcm$(ZIPSUFFIX).zip ufpcm$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpcmkcfg$(ZIPSUFFIX).zip ufpck$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpcres$(ZIPSUFFIX).zip ufprs$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpcreslipo$(ZIPSUFFIX).zip ufprl$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpdoc$(ZIPSUFFIX).zip ufpdc$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fpmc$(ZIPSUFFIX).zip ufpmc$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fppkg$(ZIPSUFFIX).zip ufpkg$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-fprcp$(ZIPSUFFIX).zip ufprc$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-h2pas$(ZIPSUFFIX).zip uh2pa$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-ihxutil$(ZIPSUFFIX).zip uihxu$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-importtl$(ZIPSUFFIX).zip uimpt$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-instantfpc$(ZIPSUFFIX).zip uifpc$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-javaapp$(ZIPSUFFIX).zip ujvp$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-json2pas$(ZIPSUFFIX).zip jsnp$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-lexyacc$(ZIPSUFFIX).zip ulexy$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-mksymbian$(ZIPSUFFIX).zip umksb$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-pas2fpm$(ZIPSUFFIX).zip up2fp$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-pas2jni$(ZIPSUFFIX).zip up2jn$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-pas2js$(ZIPSUFFIX).zip uupjs$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-pas2ut$(ZIPSUFFIX).zip up2ut$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-rmwait$(ZIPSUFFIX).zip urmw$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-sim_pasc$(ZIPSUFFIX).zip usmp$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-svn2cvs$(ZIPSUFFIX).zip us2c$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-unicode$(ZIPSUFFIX).zip uucd$(ZIPSUFFIXSHORT).zip
	-$(MOVE) $(PKGPRE)utils-wasbin$(ZIPSUFFIX).zip uwsbn$(ZIPSUFFIXSHORT).zip
...
ifeq ($(findstring 3.0.,$(PACKAGE_VERSION)),)
ifndef NOGDB
ifndef NOGDBMI
...
innoandroidbuild:
	...
	$(DELTREE) $(INNODIR)
	$(MKDIR) $(INNODIR)
	$(MAKE) -C fpcsrc rtl_clean packages_clean OS_TARGET=android CPU_TARGET=arm
	$(MAKE) build OS_TARGET=android CPU_TARGET=arm CROSSINSTALL=1
	...
	$(MAKE) -C fpcsrc rtl_clean packages_clean OS_TARGET=android CPU_TARGET=arm
	$(MAKE) build OS_TARGET=android CPU_TARGET=arm CROSSOPT="-Cparmv7a -Cfvfpv3_d16" CROSSINSTALL=1
	$(MAKE) crossinstall INSTALL_PREFIX=$(INNODIR) OS_TARGET=android CPU_TARGET=arm
	...
	$(DEL) fpcsrc/build-stamp.arm-android
	$(MAKE) build OS_TARGET=android CPU_TARGET=aarch64 CROSSINSTALL=1
	$(MAKE) crossinstall INSTALL_PREFIX=$(INNODIR) OS_TARGET=android CPU_TARGET=aarch64
	$(MAKE) build OS_TARGET=android CPU_TARGET=i386 CROSSINSTALL=1
	$(MAKE) crossinstall INSTALL_PREFIX=$(INNODIR) OS_TARGET=android CPU_TARGET=i386
	$(MAKE) build OS_TARGET=android CPU_TARGET=x86_64 CROSSINSTALL=1
	$(MAKE) crossinstall INSTALL_PREFIX=$(INNODIR) OS_TARGET=android CPU_TARGET=x86_64
	$(MAKE) build OS_TARGET=android CPU_TARGET=mipsel CROSSINSTALL=1
