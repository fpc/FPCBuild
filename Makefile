#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2007/09/11]
#
default: help
...
renametoshort:
	...
	-mv $(PKGUNITSPRE)fcl-passrc$(ZIPSUFFIX).zip ufclp$(ZIPSUFFIXSHORT).zip
	...
	-mv $(PKGUNITSPRE)oggvorbis$(ZIPSUFFIX).zip uoggv$(ZIPSUFFIXSHORT).zip
	-mv $(PKGUNITSPRE)openal$(ZIPSUFFIX).zip uoal$(ZIPSUFFIXSHORT).zip
	-mv $(PKGUNITSPRE)openssl$(ZIPSUFFIX).zip uossl$(ZIPSUFFIXSHORT).zip
shortsrc:
...
innoclean:
	...
	$(DELTREE) $(INNODIR)
innoce : checkfpcdir
	$(MAKE) OS_TARGET=wince CPU_TARGET=arm innocebuild
	$(MAKE) innoclean	
innox64 : checkfpcdir
	$(MAKE) OS_TARGET=win64 CPU_TARGET=x86_64 innox64build
	$(MAKE) innoclean	
