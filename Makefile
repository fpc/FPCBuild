...
renametoshort:
	...
	-mv $(PKGPRE)$(PKGUNITSPRE)httpd-1.3$(ZIPSUFFIX).zip uhd13$(ZIPSUFFIXSHORT).zip
	-mv $(PKGPRE)$(PKGUNITSPRE)httpd-2.0$(ZIPSUFFIX).zip uhd20$(ZIPSUFFIXSHORT).zip
	-mv $(PKGPRE)$(PKGUNITSPRE)httpd-2.2$(ZIPSUFFIX).zip uhd22$(ZIPSUFFIXSHORT).zip
