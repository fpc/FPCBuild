...
Free Pascal 2.2.4 is currently available for the following platforms:
- Linux-i386
- Linux-x86_64 (amd64)
- Linux-powerpc
- Linux-sparc
...
Download the distribution package (fpc-2.2.4.i386-win32.exe) and run it
...
Download distribution archive (dos224.zip for GO32v2) and unzip it into
...
Download distribution archive (os2224.zip for OS/2 or eComStation) and unzip
...
Download fpc-2.2.4.<cpu>-<os>.tar and untar into a temporary directory.
...
1) Download and install the Mac OS X package (fpc-2.2.4.powerpc-macosx.dmg)
...
ftp://ftp.freepascal.org/fpc/dist/docs-2.2.4
