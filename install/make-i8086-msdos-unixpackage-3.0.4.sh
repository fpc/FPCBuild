...
# hacky script for building the i8086-msdos release package for the fpc 3.0.x series
...
rm -r $BASEDIR/OUTPUT-MSDOS/lib/fpc/3.1.*
rm -r $BASEDIR/OUTPUT-MSDOS/lib/fpc/3.0.2
